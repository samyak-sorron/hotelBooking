...
const PropertyList = () => {
  const url = `${import.meta.env.VITE_URL}/hotels/countByType`;
  ...
  const images = {
    ...
    "guest house": "https://cf.bstatic.com/static/img/theme-index/carousel_320x240/card-image-apartments_300/9f60235dc09a3ac3f0a93adbc901c61ecd1ce72e.jpg",
